            ...
            <div className="garage">
              ...
              <div className="garage-container flex items-center">
                <ul className="underline font-semibold text-[10px] space-y-5 mr-6">
                  <li>
                    <a href="#">Xe Liên Hưng</a>
                  </li>
                  <li>
                    <a href="#">Xe Long Vân Limousine</a>
                  </li>
                  <li>
                    <a href="#">Xe Vie Limousine</a>
                  </li>
                  <li>
                    <a href="#">Xe Cúc Tùng</a>
                  </li>
                  <li>
                    <a href="#">Xe An Phú Buslines</a>
                  </li>
                  <li>
                    <a href="#">Xe Bằng Phấn</a>
                  </li>
                  <li>
                    <a href="#">Xe Hà Lan</a>
                  </li>
                  <li>
                    <a href="#">Xe 36 Limousine</a>
                  </li>
                </ul>
                {/*  */}
                <ul className="underline font-semibold text-[10px] space-y-5 mr-2">
                  ...
                  <li>
                    <a href="#">Xe Tân Kim Chi</a>
                  </li>
                  <li>
                    <a href="#">Xe Quang Nghị</a>
                  </li>
                  <li>
                    <a href="#">Xe Nam Cường Limousine</a>
                  </li>
                  <li>
                    <a href="#">Xe Phúc Xuyên</a>
                  </li>
                </ul>
                {/*  */}
                <ul className="underline font-semibold text-[10px] space-y-5 mr-[25px]">
                  <li>
                    <a href="#">Xe Điền Linh</a>
                  </li>
                  <li>
                    <a href="#">Xe Tuấn Hưng</a>
                  </li>
                  <li>
                    <a href="#">Xe Phong Phú</a>
                  </li>
                  <li>
                    <a href="#">Xe Trà Lan Viên</a>
                  </li>
                  <li>
                    <a href="#">Xe Nam Quỳnh Anh</a>
                  </li>
                  <li>
                    <a href="#">Xe G8 Open Tour</a>
                  </li>
                  <li>
                    <a href="#">Xe Hải Âu</a>
                  </li>
                  <li>
                    <a href="#">Xe Tràng An Limousine</a>
                  </li>
                </ul>
                {/*  */}
                <ul className="underline font-semibold text-[10px] space-y-5">
                  <li>
                    <a href="#">Xe Đồng Phước</a>
                  </li>
                  <li>
                    <a href="#">Xe Hảo</a>
                  </li>
                  ...
                  <li>
                    <a href="#">Xe An Phú Quý</a>
                  </li>
                  <li>
                    <a href="#">Xe Xuân Tráng Limousine</a>
                  </li>
                  <li>
                    <a href="#">Xe Sao Việt</a>
                  </li>
                  <li>
                    <a href="#">Xe Sao Nghệ Limousine</a>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="flex items-start justify-start">
            <div className="supports mr-[34px]">
              ...
              <ul className="underline font-semibold text-[14px] space-y-5">
                ...
                <li>
                  <a href="#">Chính sách và quy trình giải</a>
                </li>
                <li>
            ...
            <div className="abouts mr-[93px]">
              ...
              <ul className="underline font-semibold text-[14px] space-y-5">
                ...
                <li>
                  <a href="#">Giới Thiệu Vexere.com</a>
                </li>
                <li>
                  <a href="#">Tuyển dụng</a>
                </li>
              ...
              <img src="../image/certificates.png" className="w-200 h-20" />
            </div>
            <div className="payments mr-[43px]">
              ...
              <img
                src="../image/payment_partner.png"
                className="w-[202px] h-[344px]"
              />
            </div>
            <div className="dow-app">
              ...
              <img src="../image/qr_code.png" className="size-[164px]" />
            </div>
          </div>
        </div>
      </div>
